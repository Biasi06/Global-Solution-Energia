...
# --- 2. GERAR DADOS DE CONSUMO (PARA 2023) ---
# (Isto substitui o script 'gerar_consumo.py')
...
# --- 3. CARREGAR E LIMPAR DADOS DE GERAÇÃO (DE 2023) ---
...
# Formatar colunas de geração
df_geracao.rename(columns={'P': 'geracao_kwh'}, inplace=True)
# AVISO: O 'time' do PVGIS pode ser '20230101:0003'. Vamos tratar isso.
# Vamos pegar apenas os 12 primeiros caracteres (ex: '20230101:00')
...
# --- 4. UNIR DADOS E CALCULAR BALANÇO ---
...
# --- 5. ANÁLISE DE CUSTOS E AMBIENTAL ---
...
df_dia_pico = df_completo[
    ...
    (df_completo['dia_semana'] == 2)  # 2 = Quarta-feira
].copy()
